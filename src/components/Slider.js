      ...
      <section id="hero">
        <div id="heroCarousel" data-bs-interval="5000" className="carousel slide carousel-fade" data-bs-ride="carousel">
          ...
          <div className="carousel-inner" role="listbox">
            ...
            <div className="carousel-item active" style={{ backgroundImage: "url(../../public/assets/img/slide/slide-1.jpg)" }}>
              <div className="carousel-container">
                <div className="container">
                  <h2 className="animate__animated animate__fadeInDown">Erdoğan Dekorasyon'a <span>Hoşgeldiniz</span></h2>
                  <p className="animate__animated animate__fadeInUp">Hertürlü mobilya işiniz için güvenilir adres.</p>
